    ...
    forgotPassword: async (req, res) => {
        try {
            ...
            await transporter.sendMail({
                from: 'bitaurban.shop@gmail.com>', // sender address
                to: email, // list of receivers
                subject: "Xác nhận khôi phục mật khẩu tài khoản Bita Urban", // Subject line
                ...
                <body>
                  <span class="preheader">Bạn đã yêu cầu khôi phục mật khẩu tài khoản của bạn trên hệ thống bán quần áo Bita Urban</span>
                              ...
                              <td class="wrapper">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td>
                                      <p>Chào bạn,</p>
                                      <p>Chúng tôi nhận được yêu cầu khôi phục mật khẩu tài khoản của bạn trên hệ thống bán hàng Bita Urban của chúng tôi. Hãy bấm nút Xác nhận để thực hiện đổi lại mật khẩu.</p>
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td class="content-block">
                                  <span class="apple-link">Bita Urban, Binh Thanh district, Ho Chi Minh city</span>        
                                </td>
                              </tr>
                              <tr>
                                <td class="content-block powered-by">
                                  Powered by Bita Urban.
                                </td>
                              </tr>
                            </table>
                          </div>
            ...
            res.json({ msg: 'An email has been sent to your email' })
        } catch (err) {
            return res.status(500).json({ msg: err.message })
        }
    },
