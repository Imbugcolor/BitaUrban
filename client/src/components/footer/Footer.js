...
import Logo from '../logo/bita-urban-tagline.png'
                ...
                <div className="res-row">
                    ...
                    <div className="col l-3 m-3 c-6 footer-item">
                        <div className="footer-item social-network">
                            ...
                            <ul>
                                <li>
                                    <a href="https://www.facebook.com/profile.php?id=100088054956329">
                    ...
                    <div className="col l-3 m-3 c-6 footer-item">
                        <div className="footer-item policy">
                            <h3 className="footer-item-header">Về Bita Urban</h3>
                            <ul>
                                <li>
                    ...
                    <div className="col l-12 m-12 c-12">
                        <h5 className="copyright">Designed by Thuần Việt Duy Thuận Corporation</h5>
                    </div>
                </div>
            </div>
        </footer>
